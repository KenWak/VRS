...
<head>
    ...
    <title>Librarian Login Form | VRS </title>
...
<body class="login" style="background-image: url(images/library15.jpg);">
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            ...
            <div>
                ...
                <a class="reset_pass" href="#" STYLE="color:white;">WELCOME</a>
            </div>
