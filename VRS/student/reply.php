...
?>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form name="form1" action="" method="post" class="col-lg-6" enctype="multipart/form-date" >    
								...
								<tr>
								   ...
								   <?php 
									...
									{
										 $id=$_GET["id"];
										$res1=mysqli_query($link,"select * from librarian_registration where id=$id");
									while ($row1=mysqli_fetch_array($res1))
									{
										$fullid=$row1["username"];
									}
		...
		{
			mysqli_query($link, "insert into student_messages values('','$_SESSION[username]','$_POST[dusername]','$_POST[title]','$_POST[msg]','n')") or die(mysqli_error($link));
